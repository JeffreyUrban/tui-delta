...
from tui_delta.clear_lines import count_clear_sequences, clear_lines, _format_line
...
class TestClearLinesEdgeCases:
    ...
    def test_empty_input(self):
        ...
        with pytest.raises(IndexError):
            clear_lines(fifo, clear_count=1, show_prefixes=True,
                       show_line_numbers=False, clear_operation_count=0, rules=rules)
...
class TestConsolidateEdgeCases:
    ...
    def test_parse_kept_line(self):
        ...
        from tui_delta.consolidate_clears import parse_line, LineType
