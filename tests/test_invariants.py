...
class TestClearLinesInvariants:
    ...
    def test_clear_count_never_exceeds_available(self):
        ...
        clear_lines(fifo, clear_count=10, show_prefixes=False,
    ...
    def test_fifo_order_preserved(self):
        ...
        try:
            ...
            clear_lines(fifo, clear_count=3, show_prefixes=False,
                       show_line_numbers=False, clear_operation_count=0, rules=rules)
    ...
    def test_kept_prefix_is_plus(self):
        ...
        try:
            ...
            clear_lines(fifo, clear_count=2, show_prefixes=True,
                       show_line_numbers=False, clear_operation_count=0, rules=rules)
